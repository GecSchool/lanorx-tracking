...
export function useTracking() {
  ...
  const trackCTA = useCallback(
    async (section: string, contentId?: string): Promise<ApiResponse<EventTrackResponse>> => {
  ...
  const trackNavigate = useCallback(
    async (meta?: Record<string, any>, contentId?: string): Promise<ApiResponse<EventTrackResponse>> => {
